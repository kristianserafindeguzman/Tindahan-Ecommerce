          ...
          <div class="row q-col-gutter-y-md q-col-gutter-x-xl q-mb-lg">
            ...
            <div class="col-12">
              ...
              <div class="bg-grey-1 rounded-borders q-pa-sm custom-glass-input">
                <div v-for="day in getFormattedSchedule(selectedApplication.store)" :key="day.day" class="row justify-between items-center q-py-xs" :class="day.isOpen ? 'text-dark' : 'text-grey-5'">
