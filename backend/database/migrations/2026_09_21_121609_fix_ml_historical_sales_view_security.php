...
return new class extends Migration
{
    ...
    {
        // Fix the definer error when importing views across environments
        \Illuminate\Support\Facades\DB::statement("
            ALTER SQL SECURITY INVOKER VIEW ml_historical_sales_view AS
            SELECT 
                transaction_date,
                store_id,
                inventory_id,
    ...
    {
        // Revert to default security if needed
        \Illuminate\Support\Facades\DB::statement("
            ALTER SQL SECURITY DEFINER VIEW ml_historical_sales_view AS
            SELECT 
                transaction_date,
                store_id,
                inventory_id,
